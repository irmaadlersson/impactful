    ...
    return (
      <Style>
        ...
        >
                  ...
                  >
                    <div className="rectangle-mobile">
                      <div className="slot">
                        ...
                        <p className="h2">
                          What’s in a Name: An Analysis of Impact Investing Understandings by
                          Academics and Practitioners
                        </p>
                        <a
                          className="link"
                          href="https://link-springer-com.ezproxy.ub.gu.se/article/10.1007/s10551-014-2327-0E2"
                          rel="noopener noreferrer"
                          target="_blank"
                        >
                          Go to article
                  ...
                  >
                    <div className="rectangle-mobile">
                      <div className="slot">
                        ...
                        <p className="h2">
                          Interrogating the theory of change: evaluating impact investing where it
                          matters
                        </p>
                        <a
                          className="link"
                          href="https://www.tandfonline.com/doi/full/10.1080/20430795.2013.776257"
                          rel="noopener noreferrer"
                          target="_blank"
                        >
                          Go to article
                  ...
                  >
                    <div className="rectangle-mobile">
                      <div className="slot">
                        ...
                        <p className="h2">85% of investors are interested in impact investing</p>
                        <a
                          className="link"
                  ...
                  >
                    <div className="rectangle-mobile">
                      <div className="slot">
                        ...
                        <a
                          className="link"
                          href="https://www.gogla.org/about-us/blogs/off-grid-solar-a-power-tool-for-change"
                          rel="noopener noreferrer"
                          target="_blank"
                        >
                          Go to article
          ...
          >
            <p className="h1">Impactful blogs</p>
          </GridChild>
          <GridChild
            columnSpan={[
              { start: 1 },
